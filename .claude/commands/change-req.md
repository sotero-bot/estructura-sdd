...
- Si sí y el código está mal → es un **bug**. Detener y decirle al usuario: *"Esto parece un bug, no un cambio de requisito. Descríbelo como error y usaré `sdd-classify-issue`."*
